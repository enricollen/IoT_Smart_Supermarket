...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <identifier>mtype860</identifier>
      <description>Cooja Mote Type #1</description>
      <source>[CONTIKI_DIR]/iot_paciollen/progetto/Border Router/border-router.c</source>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/iot_paciollen/progetto/CoAP Network/Weight_Sensor/ShelfScale.c</source>
      <commands>make ShelfScale.cooja TARGET=cooja</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/iot_paciollen/progetto/CoAP Network/Price_Display/display.c</source>
      <commands>make display.cooja TARGET=cooja</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
    ...
    <mote>
      <interface_config>
        ...
        <x>64.75146392488207</x>
        <y>30.909634296781284</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
      ...
      <motetype_identifier>mtype860</motetype_identifier>
    </mote>
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>94.09934548390387</x>
        <y>8.70115818638233</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>53.85240933903026</x>
        <y>14.098555201736218</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>84.01261562409609</x>
        <y>33.14380729961839</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>61.72603940020704</x>
        <y>41.65286314563673</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>6.502077683673016 0.0 0.0 6.502077683673016 -271.79690164723075 -9.302879193058041</viewport>
    </plugin_config>
    <width>400</width>
    <z>3</z>
    <height>400</height>
